...
//             const container = selectedRange.startContainer.parentElement.closest('.editar');
...
// document.querySelectorAll('.editar').forEach((element, index) => {
...
//     const range = selection.getRangeAt(0);
//     const container = range.startContainer.parentElement.closest('.editar'); // Encontra o container (div com classe 'editar')
//     const paragrafos = container.querySelectorAll('p');
